		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "QAService Freestyle App",
									"targetURL": "#qaservicefreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qaservicefreestyle-display": {
								"semanticObject": "qaservicefreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qaservicefreestyle",
									"url": sap.ui.require.toUrl("qaservicefreestyle")
								}
							}
						}
					}
