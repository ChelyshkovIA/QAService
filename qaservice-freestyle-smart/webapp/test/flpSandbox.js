		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App",
									"targetURL": "#qaservicefreestylesmart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qaservicefreestylesmart-display": {
								"semanticObject": "qaservicefreestylesmart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qaservicefreestylesmart",
									"url": sap.ui.require.toUrl("qaservicefreestylesmart")
								}
							}
						}
					}
